...
class DiagnosisDetailVC: UIViewController {
...
extension DiagnosisDetailVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
...
extension DiagnosisDetailVC: ResponseProtocol{
