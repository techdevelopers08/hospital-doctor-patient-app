...
class QRSurgeryDetailVC: UIViewController {
...
extension QRSurgeryDetailVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
...
extension QRSurgeryDetailVC: ResponseProtocol{
